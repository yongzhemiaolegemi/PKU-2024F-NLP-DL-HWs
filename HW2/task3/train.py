...
from model import RobertaForSequenceClassificationWithAdapters
...
# 初始化 WandB
wandb.init(project="my-huggingface-project", name="peft_experiment_name"+model_args.model_name_or_path+"_"+model_args.dataset)
...
# 设置学习率
training_args.learning_rate = 1e-4  # 例如，设置为 1e-4
